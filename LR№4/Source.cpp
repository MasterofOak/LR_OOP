...
//Перший function overload - далі FO в якому ми просто вводимо змінній x та y самі
Longlong Longlong::addition(double x , double y) {
	Longlong tmp{};
	result = (first_x + x) + (second_x + y);
	cout << "Result of addition: ";
	toString();
...
//Другий FO в якому ми просто вводимо змінній x та y самі
Longlong Longlong::subtraction(double x, double y) {
	Longlong tmp{};
	x = first_y;
	y = second_y;
	result = (first_x + x) - (second_x + y);
...
//Третій FO в якому ми просто вводимо змінній x та y самі
Longlong Longlong::multiplication(double x, double y) {
	Longlong tmp{};
	result = (first_x + x) * (second_x + y);
	cout << "Result of multiplcation: ";
	toString();
...
//Четвертий FO в якому ми просто вводимо змінній x та y самі
Longlong Longlong::division(double x, double y) {
	Longlong tmp{};
	result = (first_x + x) / (second_x + y);
	cout << "Result of division: ";
	toString();
